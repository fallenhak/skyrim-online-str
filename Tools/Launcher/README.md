...
| JContainers SE | **Nexus 4.3.2** | En yeni Nexus dosyası SKSE 2.3.1 / Skyrim 1.7.104'ü bildiriyor. STR'nin Lua bellek düzeltmesi upstream'e `ac9ec71` ile alınmış ve bu sürümde var. Oyun içi test yapılmadı. | [Nexus 4.3.2](https://www.nexusmods.com/skyrimspecialedition/mods/16495), [upstream düzeltme](https://github.com/ryobg/JContainers/commit/ac9ec71), [STR duyurusu](https://github.com/rfortier/TiltedEvolution-rwf/releases) |
...
En yeni Nexus JContainers 4.3.2 (16495 / file 800245) Skyrim 1.7.104'ü bildiriyor ve STR düzeltmesi upstream'e birleşmiş durumda. Ancak bu MO2 anlık görüntüsünde hem özel JContainers klasörü devre dışı hem de Nexus sürümü etkin değil; manifest ikisini de kurmuyor. Crash Logger 1.25.0 changelog'u 1.7.99 desteğini yazıyor; 1.7.104 desteği belirtilmediğinden dağıtıma alınmadı. Skyrim Souls RE etkin profilde yoktur ve resmi 3.1.2 DLL'i hedef runtime'ı desteklemez.
