-- Local copy of xmake-repo packages/g/gamenetworkingsockets/xmake.lua (f0a85e117f30).
-- Only change: depend on "openssl" instead of "openssl3", so the root
-- add_requireconfs("*.openssl", 1.1.1-w) pin also covers GameNetworkingSockets.
-- Upstream switched to openssl3 on 2026-09-15 (#10834); building GNS against
-- OpenSSL 3 headers left EVP_DigestSignUpdate undefined in libSTServer.so.
